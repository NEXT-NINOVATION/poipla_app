...
class ObstacleManager extends Component
  ...
  void _spawnEnemy() {
    ...
    if (gameRef.buildContext != null) {
      ...
      // 障害物の場合大きさ変更
      // if (enemyData.objectType == 1) {
      //   initialSize = Vector2(150, 150);
      // }

      Obstacle obstacle = Obstacle(
        sprite: spriteSheet.getSpriteById(obstacleData.spriteId),
        size: obstacleData.objectSize,
        position: position,
  ...
  /// [EnemyData]の非公開リスト。
  final List<ObstacleData> _obstacleDataList = [
    ObstacleData(
      point: 1,
      speed: 200,
      spriteId: 6,
